...
export const GenreCard = ({ className, title, isTopTen, images, onClick }: GenreCardProps) => {
  return (
    <div
      onClick={onClick}
      className={cn(
        'min-w-[11.25rem] bg-quaternary inline-grid rounded-xl border border-quinary py-4 px-2 hover:bg-gray-900/50 transition-colors duration-200 cursor-pointer group',
        className,
      )}>
